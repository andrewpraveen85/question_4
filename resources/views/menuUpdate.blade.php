...
@section('content')
    ...
    <h2>Update</h2>
    <form method="POST" action="{{ route('menu.update.confirm') }}" enctype="multipart/form-data">
        @csrf <!-- {{ csrf_field() }} -->
        <div class="form-floating mb-3">
            <input type="text" class="form-control" id="floatingInput" name="menu_name" placeholder="menu_name" value="{{$menu->menu_name}}" required>
        ...
        <div class="form-floating mb-3">
            <input type="number" step="10" min="100" class="form-control" id="floatingInput" name="menu_price" placeholder="menu_price" value="{{$menu->menu_price}}" required>
